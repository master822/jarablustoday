    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card-rizk p-4">
                ...
                <form action="{{ route('merchant.jobs.store') }}" method="POST">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="location" class="form-control form-rizk" placeholder="مدينة العمل">
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label style="color: var(--text-primary);">تاريخ انتهاء الإعلان</label>
